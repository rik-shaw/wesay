...
namespace WeSay.UI.TextBoxes
{
	...
	public class GeckoBase : UserControl
	{
		...
		private EventHandler<DomKeyEventArgs> _domKeyUpHandler;
		protected EventHandler<DomMouseEventArgs> _domClickHandler;
		private EventHandler<DomKeyEventArgs> _domKeyDownHandler;
		private EventHandler<DomEventArgs> _domFocusHandler;
		private EventHandler<DomEventArgs> _domBlurHandler;
		private EventHandler<GeckoDocumentCompletedEventArgs> _domDocumentCompletedHandler;
		private EventHandler _backColorChangedHandler;
		private EventHandler _foreColorChangedHandler;
